...
import com.victxl.curso.services.ServiceItemPedido;
...
public class ResourcesItemPedido {
    @Autowired
    private ServiceItemPedido service;
    @GetMapping
    ...
    public ResponseEntity<ItemPedido> findById(@PathVariable Long id) {
        ItemPedido usuario = service.findById(id);
